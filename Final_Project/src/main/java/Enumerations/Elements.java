...
public class Elements {
    ...
    public enum ExceptionValues {
        ...
        public static final String UNKNOWN_COMPANY = "“Consumidor final";
        public static final String UNKNOWN_ACCOUNT = "Desconhecido";
    }
    ...
    public enum SequenceElements {
        ...
        public static LinkedList<String> getList() {
            SequenceElements[] array = SequenceElements.values();
            LinkedList<String> list = new LinkedList<>();

            for (SequenceElements sequenceElements : array) {
                list.add(sequenceElements.name());
            }
