    ...
    public static Map<String, Object> getFileByName(Driver driver, String fileName) {
        try (Session session = driver.session()) {
            Record queryResult = session.writeTransaction(tx -> tx.run(""
                    ...
                    + "MATCH (si)-[:" + Entities.SalesInvoicesRelationships.HAS_TOTAL_DEBIT + "]->(sitd:" + Entities.Labels.SalesInvoices + ")\n"
                    + "MATCH (si)-[:" + Entities.SalesInvoicesRelationships.HAS_TOTAL_CREDIT + "]->(sitc:" + Entities.Labels.SalesInvoices + ")\n"

                    //Invoice
                    + "MATCH (si)-[:" + Entities.SalesInvoicesRelationships.HAS_INVOICE + "]->(i:" + Entities.Labels.Invoice + ")\n"
                    + "MATCH (i)-[:" + Entities.InvoiceRelationships.HAS_ATCUD + "]->(atcud:" + Entities.Labels.InvoiceInfo + ")\n"

                    //DocumentStatus
                    + "MATCH (i)-[:" + Entities.InvoiceRelationships.HAS_DOCUMENT_STATUS + "]->(ids:" + Entities.Labels.InvoiceInfo + ")\n"
                    ...
                    + "MATCH (i)-[:" + Entities.InvoiceRelationships.HAS_HASH + "]->(ih:" + Entities.Labels.InvoiceInfo + ")\n"
                    + "MATCH (i)-[:" + Entities.InvoiceRelationships.HAS_HASH_CONTROL + "]->(ihc:" + Entities.Labels.InvoiceInfo + ")\n"
                    + "MATCH (i)-[:" + Entities.InvoiceRelationships.HAS_PERIOD + "]->(ip:" + Entities.Labels.InvoiceInfo + ")\n"
                    + "MATCH (i)-[:" + Entities.InvoiceRelationships.HAS_INVOICE_DATE + "]->(iid:" + Entities.Labels.InvoiceInfo + ")\n"
                    + "MATCH (i)-[:" + Entities.InvoiceRelationships.HAS_INVOICE_TYPE + "]->(iit:" + Entities.Labels.InvoiceInfo + ")\n"

                    //SpecialRegimes
                    + "MATCH (i)-[:" + Entities.InvoiceRelationships.HAS_SPECIAL_REGIMES + "]->(isr:" + Entities.Labels.InvoiceInfo + ")\n"
                    ...
                    + "MATCH (i)-[:" + Entities.InvoiceRelationships.HAS_SOURCE_ID + "]->(isid:" + Entities.Labels.InvoiceInfo + ")\n"
                    + "OPTIONAL MATCH (i)-[:" + Entities.InvoiceRelationships.HAS_EAC_CODE + "]->(ieac:" + Entities.Labels.InvoiceInfo + ")\n"
                    + "MATCH (i)-[:" + Entities.InvoiceRelationships.HAS_SYSTEM_ENTRY_DATE + "]->(ised:" + Entities.Labels.InvoiceInfo + ")\n"
                    + "OPTIONAL MATCH (i)-[:" + Entities.OtherRelationships.HAS_TRANSACTION + "]->(it:" + Entities.Labels.Transaction + ")\n"
                    + "MATCH (i)-[:" + Entities.OtherRelationships.HAS_CUSTOMER + "]->(ic:" + Entities.Labels.Customer + ")\n"
                    ...
                    //Line
                    + "MATCH (i)-[:" + Entities.InvoiceRelationships.HAS_LINE + "]->(il:" + Entities.Labels.InvoiceInfo + ")\n"
                    ...
                    + "MATCH (il)-[:" + Entities.OtherRelationships.HAS_PRODUCT + "]->(p:" + Entities.Labels.Product + ")\n"
                    + "MATCH (p)-[:" + Entities.ProductRelationships.HAS_PRODUCT_DESCRIPTION + "]->(pd:" + Entities.Labels.ProductInfo + ")\n"
                    + "MATCH (il)-[:" + Entities.LineRelationships.HAS_QUANTITY + "]->(ilq:" + Entities.Labels.InvoiceInfo + ")\n"
                    + "MATCH (il)-[:" + Entities.LineRelationships.HAS_UNIT_OF_MEASURE + "]->(ilum:" + Entities.Labels.InvoiceInfo + ")\n"
                    + "MATCH (il)-[:" + Entities.LineRelationships.HAS_UNIT_PRICE + "]->(ilup:" + Entities.Labels.InvoiceInfo + ")\n"
                    ...
                    + "RETURN Header, MasterFiles, GeneralLedgerEntries, SalesInvoices\n"
            ).single());
