...
import Application.Enums.EnumsOfElements;
 ...
 * o leitor de XML realiza a sua leitura
 *
 * @author José Miguel Ribeiro Cunha
 */
public class MapperManager {

    /*Classe responsável por realizar as transações com o Neo4j*/
    ...
    private final LinkedList<Map<String, Long>> companies;
    private final LinkedList<Map<String, Long>> accounts;
     ...
     * Método construtor
     *
     * @param driver insância da classe responsável por realizar transações com o Neo4j
     */
    ...
    public void processStartElement(String XMLElement, String value) {
        ...
        try {
            ...
            /**
             * Caso seja um elemento de sequência, adicionamo-lo à lista que irá conter
             * outros elementos de sequência e incrementamos a profundidade
             */
     ...
     * Nota: Apenas é realizada alguma ação quando este é um elemento de sequência.
     *
     ...
     * caso estes ainda não estejam presentes na mesma
     */
    ...
    /**
     * Método responsável pela criação de um nó sem qualquer atributo
     *
     * @return id do nó criado
     */
    ...
    /**
     * Método responsável pela criação de um nó com um atributo
     * do tipo inteiro
     *
    ...
    private long findCompanyNodeId(String XMLElement) throws NodeException {
        Iterator<Map<String, Long>> iterator = this.companies.iterator();
    ...
    private long findAccountNodeId(String XMLElement) throws NodeException {
        Iterator<Map<String, Long>> iterator = this.accounts.iterator();
    ...
    private long findCustomerNodeId(String XMLElement) throws NodeException {
        Iterator<Map<String, Long>> iterator = this.customers.iterator();
    ...
    private long findSupplierNodeId(String XMLElement) throws NodeException {
        Iterator<Map<String, Long>> iterator = this.suppliers.iterator();
    ...
    private long findProductNodeId(String XMLElement) throws NodeException {
        Iterator<Map<String, Long>> iterator = this.products.iterator();
    ...
    private long findTransactionNodeId(String XMLElement) throws NodeException {
        Iterator<Map<String, Long>> iterator = this.transactions.iterator();
    ...
    private long findSourceNodeId(String XMLElement) throws NodeException {
        Iterator<Map<String, Long>> iterator = this.sources.iterator();
        ...
        if (this.depth == count) {
            ...
            switch (XMLElement) {
                ...
                case EnumsOfElements.Header.CompanyName:
                    ...
                    //Adicionamos à lista de companies
                    map = new HashMap<>();
                    map.put(value, id);
                    this.companies.add(map);

                    //Criamos o nó do tipo Company com o atributo CompanyName e o seu valor
                    this.nodesContainer.add(new GraphNode(id, EnumsOfEntities.Entities.Company));
                ...
                case EnumsOfElements.Header.ProductID:
                    ...
                    //Adicionamos à lista de products
                    map = new HashMap<>();
                    map.put(value, id);
    ...
    private void processAccountChildren(String XMLElement, String value) throws MapException, NodeException {
        ...
        switch (XMLElement) {
            ...
            case EnumsOfElements.Account.AccountID:
                long id = this.findNodeId(EnumsOfEntities.Entities.Account);
        ...
        if (this.depth == count) {
            ...
            switch (XMLElement) {
                ...
                case EnumsOfElements.Customer.CustomerID:
                    id = this.findNodeId(EnumsOfEntities.Entities.Customer);
                ...
                case EnumsOfElements.Customer.AccountID:
                    ...
                    this.driver.addRelationshipToAccount(this.findNodeId(EnumsOfEntities.Entities.Customer), id);
                ...
                case EnumsOfElements.Customer.CompanyName:
                    try {
                        id = this.findCompanyNodeId(value);
                    } catch (NodeException e) {
                        id = this.addNode(XMLElement, value);
                        this.nodesContainer.add(new GraphNode(id, EnumsOfEntities.Entities.Company));
                        this.driver.addRelationshipTypeOf(id, EnumsOfEntities.Entities.Company);
                    ...
                    this.driver.addRelationshipToCompany(this.findNodeId(EnumsOfEntities.Entities.Customer), id);
        ...
        if (this.depth == count) {
            ...
            switch (XMLElement) {
                ...
                case EnumsOfElements.Supplier.SupplierID:
                    long id = this.findNodeId(EnumsOfEntities.Entities.Supplier);

                    Map<String, Long> map = new HashMap<>();
                    map.put(value, id);
                    this.suppliers.add(map);
                ...
                case EnumsOfElements.Supplier.AccountID:
                    ...
                    this.driver.addRelationshipToAccount(this.findNodeId(EnumsOfEntities.Entities.Supplier), id);
                ...
                case EnumsOfElements.Supplier.CompanyName:
                    ...
                    this.driver.addRelationshipToCompany(this.findNodeId(EnumsOfEntities.Entities.Supplier), id);
        ...
        if (this.depth == count) {
            ...
            switch (XMLElement) {
                ...
                case EnumsOfElements.Product.ProductCode:
                    long id = this.findNodeId(EnumsOfEntities.Entities.Product);
        ...
        if (this.depth == count) {
            ...
            switch (XMLElement) {
                ...
                case EnumsOfElements.Transaction.TransactionID:
                    long id = this.findNodeId(EnumsOfEntities.Entities.Transaction);

                    Map<String, Long> map = new HashMap<>();
                    map.put(value, id);
                    this.transactions.add(map);
                ...
                case EnumsOfElements.Transaction.SourceID:
                    try {
                        id = this.findSourceNodeId(value);
                    } catch (NodeException e) {
                        id = this.addNode(XMLElement, value);
                        this.nodesContainer.add(new GraphNode(id, XMLElement));
                        this.driver.addRelationshipTypeOf(id, XMLElement);
                    ...
                    this.driver.addRelationshipToSourceID(this.findNodeId(EnumsOfEntities.Entities.Transaction), id);
                ...
                case EnumsOfElements.Transaction.CustomerID:
                    try {
                        id = this.findCustomerNodeId(value);
                    } catch (NodeException e) {
                        id = this.addNode(XMLElement, value);
                    ...
                    this.driver.addRelationshipToCustomer(this.findNodeId(EnumsOfEntities.Entities.Transaction), id);

                    break;

                case EnumsOfElements.Transaction.SupplierID:
                    try {
                        id = this.findSupplierNodeId(value);
                    } catch (NodeException e) {
                        id = this.addNode(XMLElement, value);
                    ...
                    this.driver.addRelationshipToSupplier(this.findNodeId(EnumsOfEntities.Entities.Transaction), id);
        ...
        if (this.depth == count) {
            ...
            switch (XMLElement) {
                ...
                case EnumsOfElements.Invoice.SourceID:
                    ...
                    this.driver.addRelationshipToSourceID(this.findNodeId(EnumsOfEntities.Entities.Invoice), id);
                ...
                case EnumsOfElements.Invoice.TransactionID:
                    try {
                        id = this.findTransactionNodeId(value);
                    } catch (NodeException e) {
                        id = this.addNode(XMLElement, value);
                        this.nodesContainer.add(new GraphNode(id, EnumsOfEntities.Entities.Transaction));
                        this.driver.addRelationshipTypeOf(id, EnumsOfEntities.Entities.Transaction);
                    ...
                    this.driver.addRelationshipToTransaction(this.findNodeId(EnumsOfEntities.Entities.Invoice), id);
                ...
                case EnumsOfElements.Invoice.CustomerID:
                    ...
                    this.driver.addRelationshipToCustomer(this.findNodeId(EnumsOfEntities.Entities.Invoice), id);
    ...
    private void processDocumentStatusChildren(String XMLElement, String value) throws MapException, NodeException {
        ...
        switch (XMLElement) {
            ...
            case EnumsOfElements.DocumentStatus.SourceID:
                ...
                this.driver.addRelationshipToSourceID(this.findNodeId(EnumsOfElements.Invoice.DocumentStatus), id);
        ...
        if (this.depth == count) {
            ...
            switch (XMLElement) {
                ...
                case EnumsOfElements.Line.ProductCode:
                    ...
                    try {
                        id = this.findProductNodeId(value);
                    } catch (NodeException e) {
                        id = this.addNode(XMLElement, value);
                        this.nodesContainer.add(new GraphNode(id, EnumsOfEntities.Entities.Product));
                        this.driver.addRelationshipTypeOf(id, EnumsOfEntities.Entities.Product);
            ...
            switch (this.manageSequenceElements.get(count).getXMLElement()) {
                ...
                case EnumsOfElements.Line.Tax:
                    ...
                    if (EnumsOfElements.Line.Tax.equalsIgnoreCase(XMLElement)) {
                        ...
                        //Adicionamos a relação deste com o nó Line
                        this.driver.addRelationship(this.findNodeId(EnumsOfElements.Invoice.Line), this.findNodeId(XMLElement), EnumsOfEntities.LineRelationships.HAS_TAX_TABLE);
